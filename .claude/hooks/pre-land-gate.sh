...
def main():
    ...
    if is_git_commit:
        remind(
            ...
            "(1) all deterministic checks pass (ruff + check_projections.py), "
            "(2) AI GPU code review for kernel changes, "
            "(3) AI performance analysis for kernel/pipeline changes, "
            "(4) AI zero-copy analysis for transform_buffers/pipeline changes. "
