...
| `gnom` | inverse | `hypot`, clamped `asin`, `atan2` | exact spherical origin domains; projected radius unbounded; ellipsoidal setup rejected | stable normalized radius removes central-angle trig | `native.libdevice` | native stable scaled algebra; center, axes, and huge finite radii covered | T3 |
